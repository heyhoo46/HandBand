...
module SPI_Slave_Intf #(
    ...
    reg [DATA_WIDTH-1:0] si_data_reg, si_data_next;
    reg [$clog2(DATA_WIDTH):0] si_bit_cnt_reg, si_bit_cnt_next;
    ...
    reg [DATA_WIDTH-1:0] so_data_reg, so_data_next;
    reg [$clog2(DATA_WIDTH):0] so_bit_cnt_reg, so_bit_cnt_next;
    reg so_done_reg, so_done_next;

    assign so_done = so_done_reg;
    assign MISO = ~SS ? so_data_reg[DATA_WIDTH-1] : 1'bz;
...
module SPI_Slave_Reg #(
    ...
    reg [DATA_WIDTH-1:0] slv_reg0, slv_reg1, slv_reg2, slv_reg3;
