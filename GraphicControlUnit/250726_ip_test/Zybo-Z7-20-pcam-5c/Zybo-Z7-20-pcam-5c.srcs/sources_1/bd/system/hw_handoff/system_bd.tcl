...
# module references:
# AXI4_HandSignal, DVIClocking, SPI_Master_Top
...
proc create_root_design { parentCell } {
  ...
  set start_raw [ create_bd_port -dir I start_raw ]
  set sw [ create_bd_port -dir I sw ]

  # Create instance: AXI4_HandSignal_0, and set properties
  set block_name AXI4_HandSignal
  set block_cell_name AXI4_HandSignal_0
  if { [catch {set AXI4_HandSignal_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $AXI4_HandSignal_0 eq "" } {
  ...
  # Create instance: system_AXI_BayerToRG_0, and set properties
  set system_AXI_BayerToRG_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:system_AXI_BayerToRGB_1_0:1.0 system_AXI_BayerToRG_0 ]
  ...
  connect_bd_intf_net -intf_net MIPI_CSI_2_RX_0_m_axis_video [get_bd_intf_pins MIPI_CSI_2_RX_0/m_axis_video] [get_bd_intf_pins system_AXI_BayerToRG_0/AXI_Slave_Interface]
  ...
  connect_bd_intf_net -intf_net axis_register_slice_0_M_AXIS [get_bd_intf_pins AXI_GammaCorrection_0/s_axis_video] [get_bd_intf_pins axis_register_slice_0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net system_AXI_BayerToRG_0_AXI_Stream_Master [get_bd_intf_pins axis_register_slice_0/S_AXIS] [get_bd_intf_pins system_AXI_BayerToRG_0/AXI_Stream_Master]
  ...
  connect_bd_net -net AXI4_HandSignal_0_m_axis_tdata [get_bd_pins AXI4_HandSignal_0/m_axis_tdata] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tdata]
  connect_bd_net -net AXI4_HandSignal_0_m_axis_tlast [get_bd_pins AXI4_HandSignal_0/m_axis_tlast] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tlast]
  connect_bd_net -net AXI4_HandSignal_0_m_axis_tuser [get_bd_pins AXI4_HandSignal_0/m_axis_tuser] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tuser]
  connect_bd_net -net AXI4_HandSignal_0_m_axis_tvalid [get_bd_pins AXI4_HandSignal_0/m_axis_tvalid] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tvalid]
  connect_bd_net -net AXI4_HandSignal_0_o_color_spi_data [get_bd_pins AXI4_HandSignal_0/o_color_spi_data] [get_bd_pins SPI_Master_Top_0/packet_data]
  connect_bd_net -net AXI4_HandSignal_0_s_axis_tready [get_bd_pins AXI4_HandSignal_0/s_axis_tready] [get_bd_pins axi_vdma_0/m_axis_mm2s_tready]
  ...
  connect_bd_net -net PixelClk_Generator_clk_out1 [get_bd_pins AXI4_HandSignal_0/pclk] [get_bd_pins DVIClocking_0/PixelClk] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins rst_vid_clk_dyn/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins vtg/clk]
  connect_bd_net -net SPI_Master_Top_0_CS [get_bd_ports CS] [get_bd_pins SPI_Master_Top_0/CS]
  connect_bd_net -net SPI_Master_Top_0_MOSI [get_bd_ports MOSI] [get_bd_pins SPI_Master_Top_0/MOSI]
  connect_bd_net -net SPI_Master_Top_0_SCLK [get_bd_ports SCLK] [get_bd_pins SPI_Master_Top_0/SCLK]
  connect_bd_net -net axi_vdma_0_m_axis_mm2s_tdata [get_bd_pins AXI4_HandSignal_0/s_axis_tdata] [get_bd_pins axi_vdma_0/m_axis_mm2s_tdata]
  connect_bd_net -net axi_vdma_0_m_axis_mm2s_tlast [get_bd_pins AXI4_HandSignal_0/s_axis_tlast] [get_bd_pins axi_vdma_0/m_axis_mm2s_tlast]
  connect_bd_net -net axi_vdma_0_m_axis_mm2s_tuser [get_bd_pins AXI4_HandSignal_0/s_axis_tuser] [get_bd_pins axi_vdma_0/m_axis_mm2s_tuser]
  connect_bd_net -net axi_vdma_0_m_axis_mm2s_tvalid [get_bd_pins AXI4_HandSignal_0/s_axis_tvalid] [get_bd_pins axi_vdma_0/m_axis_mm2s_tvalid]
  ...
  connect_bd_net -net mm_clk_150 [get_bd_pins AXI4_HandSignal_0/aclk] [get_bd_pins AXI_GammaCorrection_0/StreamClk] [get_bd_pins MIPI_CSI_2_RX_0/video_aclk] [get_bd_pins SPI_Master_Top_0/clk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins system_AXI_BayerToRG_0/StreamClk] [get_bd_pins v_axi4s_vid_out_0/aclk]
  ...
  connect_bd_net -net rst_clk_wiz_0_50M_peripheral_aresetn [get_bd_pins AXI4_HandSignal_0/aresetn] [get_bd_pins AXI_GammaCorrection_0/aAxiLiteReset_n] [get_bd_pins AXI_GammaCorrection_0/sStreamReset_n] [get_bd_pins MIPI_CSI_2_RX_0/s_axi_lite_aresetn] [get_bd_pins MIPI_D_PHY_RX_0/s_axi_lite_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_0_50M/peripheral_aresetn] [get_bd_pins system_AXI_BayerToRG_0/sStreamReset_n] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins video_dynclk/s_axi_aresetn] [get_bd_pins vtg/s_axi_aresetn]
  connect_bd_net -net rst_clk_wiz_0_50M_peripheral_reset [get_bd_pins MIPI_D_PHY_RX_0/aRst] [get_bd_pins SPI_Master_Top_0/reset] [get_bd_pins rst_clk_wiz_0_50M/peripheral_reset]
  ...
  connect_bd_net -net start_raw_0_1 [get_bd_ports start_raw] [get_bd_pins SPI_Master_Top_0/start_raw]
  connect_bd_net -net sw_0_1 [get_bd_ports sw] [get_bd_pins AXI4_HandSignal_0/sw]
  connect_bd_net -net v_axi4s_vid_out_0_locked [get_bd_pins rgb2dvi_0/aRst_n] [get_bd_pins v_axi4s_vid_out_0/locked]
  connect_bd_net -net v_axi4s_vid_out_0_s_axis_video_tready [get_bd_pins AXI4_HandSignal_0/m_axis_tready] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tready]
