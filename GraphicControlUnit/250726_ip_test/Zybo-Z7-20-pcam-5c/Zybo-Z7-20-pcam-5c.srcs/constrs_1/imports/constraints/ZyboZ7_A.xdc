...
# set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { start_raw }]; #IO_L24N_T3_34 Sch=btn[1]
...
##Pmod Header JC
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports { start_raw }]; #IO_L10P_T1_34 Sch=jc_p[1]
...
##Pmod Header JD
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33     } [get_ports { SCLK }]; #IO_L5P_T0_34 Sch=jd_p[1]                  
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33     } [get_ports { MOSI }]; #IO_L5N_T0_34 Sch=jd_n[1]	
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33     } [get_ports { CS }]; #IO_L6P_T0_34 Sch=jd_p[2]                  
# set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33     } [get_ports { game_start }]; #IO_L6N_T0_VREF_34 Sch=jd_n[2] 
# set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33     } [get_ports { CS[1] }]; #IO_L11P_T1_SRCC_34 Sch=jd_p[3]            
