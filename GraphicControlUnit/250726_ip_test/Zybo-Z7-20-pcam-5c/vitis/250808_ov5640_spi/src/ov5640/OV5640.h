...
//		{0x3501, 0x10}, // Shorter exposure
//		{0x350B, 0x20}, // Lower gain
//
//		{0x3612, 0x20},
//		{0x3708, 0x60},
//		{0x3709, 0x50},
...
//		{0x3400, 0x17},   // R gain MSB (0.75)
//		{0x3402, 0x07},   // G gain MSB (0.75)
//		{0x3404, 0x07},   // B gain MSB (0.75)

//		{0x3503, 0x07}, // AEC/AGC 수동 모드
//		{0x3501, 0xC0}, // Exposure[15:8] (0x3501)
//		{0x3502, 0x00}, // Exposure[7:0]  (0x3502)

		{0x5001, 0x00}, // Disable auto gamma
//		{0x5480, 0x01}, // Enable manual gamma
//		{0x5481, 0x00},
//		{0x5482, 0x04},
//		{0x5483, 0x0C},
//		{0x5484, 0x16},
