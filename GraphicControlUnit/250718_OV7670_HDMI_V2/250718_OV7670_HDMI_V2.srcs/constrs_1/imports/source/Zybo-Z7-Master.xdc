...
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { ov7670_start }]; #IO_L24N_T3_34 Sch=btn[1]
...
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33     } [get_ports { ov7670_v_sync }]; #IO_L15P_T2_DQS_13 Sch=jb_p[1]		 
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33     } [get_ports { ov7670_href }]; #IO_L15N_T2_DQS_13 Sch=jb_n[1]         
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33     } [get_ports { ov7670_scl }]; #IO_L11P_T1_SRCC_13 Sch=jb_p[2]        
set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33     } [get_ports { ov7670_sda }]; #IO_L11N_T1_SRCC_13 Sch=jb_n[2]        
set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33     } [get_ports { ov7670_pclk }]; #IO_L13P_T2_MRCC_13 Sch=jb_p[3]        
set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33     } [get_ports { ov7670_xclk }]; #IO_L13N_T2_MRCC_13 Sch=jb_n[3]        
...
# ##Pmod Header JD                                                                                                                  
# set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33     } [get_ports { hdmi_clk_p_debug }]; #IO_L5P_T0_34 Sch=jd_p[1]                  
# set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33     } [get_ports { hdmi_clk_n_debug }]; #IO_L5N_T0_34 Sch=jd_n[1]	
# set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33     } [get_ports { data_raw[1] }]; #IO_L6P_T0_34 Sch=jd_p[2]                  
# set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33     } [get_ports { data_raw[2] }]; #IO_L6N_T0_VREF_34 Sch=jd_n[2] 
# # set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33     } [get_ports { hdmi_data_p_debug[1] }]; #IO_L11P_T1_SRCC_34 Sch=jd_p[3]            
# # set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33     } [get_ports { hdmi_data_n_debug[1] }]; #IO_L11N_T1_SRCC_34 Sch=jd_n[3]  
# # set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33     } [get_ports { hdmi_data_p_debug[2] }]; #IO_L21P_T3_DQS_34 Sch=jd_p[4]             
# # set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33     } [get_ports { hdmi_data_n_debug[2] }]; #IO_L21N_T3_DQS_34 Sch=jd_n[4]  
