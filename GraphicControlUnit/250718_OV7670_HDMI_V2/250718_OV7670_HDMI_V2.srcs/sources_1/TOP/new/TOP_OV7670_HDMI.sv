...
module TOP_OV7670_HDMI(
    ...
    //------------------ 24비트 RGB 패킹 (8비트×3채널) ------------------------------
    logic [7:0] red8   = {vgaRed,   ov7670_Red[4:2]}; 
    logic [7:0] green8 = {vgaGreen, ov7670_Green[5:4]}; 
    logic [7:0] blue8  = {vgaBlue,  ov7670_Blue[4:2]}; 
    logic [23:0] vid_pData = (sccb_init_busy) ? 24'h000000 : {red8, green8, blue8}; 
