...
void pipeline_mode_change(
    ...
    OV5647& cam,
    VideoOutput_OV5647& vid,
    OV5647_Resolution res,
    OV5647_cfg::mode_t mode)
{
    // 1. 카메라 입력 파이프라인 리셋 및 준비
    {
    ...
    {
        vdma_driver.configureWrite(ov5647_timing[(int)res].h_active, ov5647_timing[(int)res].v_active);
        Xil_Out32(GAMMA_BASE_ADDR, 3); // Set Gamma correction factor to 1/1.8
        cam.init();
        cam.set_mode(mode);  // <== 카메라 스트림 준비
        cam.set_awb(OV5647_cfg::AWB_SIMPLE);
    }
    {
        // Sensor & PHY 다 준비된 다음 enable
        ...
        usleep(50000);  // DPHY 안정화 대기
        vdma_driver.enableWrite();  // <== 늦게 enable
    }
    ...
    {
        vid.configure(res);
        vdma_driver.configureRead(ov5647_timing[(int)res].h_active, ov5647_timing[(int)res].v_active);
    }
    {
        vid.enable();
...
int main()
{
    ...
    VideoOutput_OV5647 vid(XPAR_VTC_0_DEVICE_ID, XPAR_VIDEO_DYNCLK_DEVICE_ID);

    // 최초 1080p 30fps로 시작
    pipeline_mode_change(vdma_driver, cam, vid, OV5647_Resolution::R1920_1080_30, OV5647_cfg::MODE_1080P_1920_1080_30);

    xil_printf("Video init done.\r\n");

    uint8_t read_char0 = 0, read_char1 = 0, read_char2 = 0, read_char4 = 0, read_char5 = 0;
    uint16_t reg_addr;
    uint8_t reg_value;
    ...
    while (1) {
        ...
        case 'a':
            ...
            xil_printf("\r\n    1. 2592 x 1944, 15fps (5MP)");
            xil_printf("\r\n    2. 1920 x 1080, 30fps (1080p)");
            xil_printf("\r\n    3. 640 x 480, 90fps (VGA)");
            read_char1 = getchar(); getchar();
            xil_printf("\r\nRead: %d", read_char1);
            switch(read_char1) {
            case '1':
                pipeline_mode_change(vdma_driver, cam, vid, OV5647_Resolution::R2592_1944_15, OV5647_cfg::MODE_2592_1944_15);
            ...
            case '2':
                ...
                break;
            case '3':
                pipeline_mode_change(vdma_driver, cam, vid, OV5647_Resolution::R640_480_60, OV5647_cfg::MODE_VGA_640_480_60);
                xil_printf("Resolution change done.\r\n");
                break;
            default:
        ...
        case 'e':
            xil_printf("\r\nPlease enter address of image sensor register (hex, small letters): \r\n");
            ...
            getchar();
            read_char1 = (read_char1 <= 57) ? read_char1 - 48 : read_char1 - 87;
            read_char2 = (read_char2 <= 57) ? read_char2 - 48 : read_char2 - 87;
            read_char4 = (read_char4 <= 57) ? read_char4 - 48 : read_char4 - 87;
            read_char5 = (read_char5 <= 57) ? read_char5 - 48 : read_char5 - 87;
            reg_addr = 16*(16*(16*read_char1 + read_char2)+read_char4)+read_char5;
            xil_printf("Desired Register Address: %x\r\n", reg_addr);

            read_char1 = read_char2 = 0;
        ...
        case 'h':
            xil_printf("  Please press the key corresponding to the test pattern:\r\n");
            xil_printf("    1. Show Colorbar\r\n");
            xil_printf("    2. Disable Test Pattern\r\n");
            read_char1 = getchar(); getchar();
            switch(read_char1) {
            case '1':
                cam.set_test(OV5647_cfg::TEST_COLORBAR);
                xil_printf("Colorbar enabled\r\n");
                break;
            case '2':
                cam.set_test(OV5647_cfg::TEST_DISABLED);
                xil_printf("Test pattern disabled\r\n");
                break;
            default:
        ...
        read_char1 = read_char2 = read_char4 = read_char5 = 0;
    }
